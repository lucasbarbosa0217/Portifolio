...
const SwiperProject: React.FC<Props> = ({ children }) => {
  ...
  return (
    <div ref={ref} className="mySwiper bookList flex lg:grid pb-8 mt-16 px-4 md:px-0 snap-x snap-mandatory justify-start lg:justify-center lg:grid-cols-2 max-h-[40rem] overflow-y-auto  gap-y-16 gap-x-8 md:p-8  w-full overflow-x-auto">
